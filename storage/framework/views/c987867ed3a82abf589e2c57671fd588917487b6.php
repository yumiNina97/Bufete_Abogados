...
<body>
    <header>
        ...
        <table style="width:100%">
            <tr>
                ...
                <td style="text-align:left; font-family: 'Times New Roman', Times, serif; font-size:12px; line-height:100%">
                    <?php echo e($cliente->nombres." ".$cliente->ap_paterno." ".$cliente->ap_materno); ?>
    ...
    <main>
        ...
        <table cellpadding="1" class="celdas" style="font-family: 'Times New Roman', Times, serif; font-size:10px; text-align:center">
            ...
            <?php $__currentLoopData = $procesos; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $p): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                   ...
                   <td><?php echo e($p->contra_demanda); ?></td>
                </tr>
        ...
        <table cellpadding="1" class="celdas" style="font-family: 'Times New Roman', Times, serif; font-size:10px; text-align:center">
            ...
            <?php $__currentLoopData = $tramites; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key => $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <tr>
                   <td><?php echo e($key+1); ?></td>
                   ...
                   <td><?php echo e($t->personas); ?></td>
                   <td><?php echo e($t->fecha_cita); ?></td>
                </tr>
            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
        </table>
        ...
        <!-- <p style="font: normal 12px/150% Times New Roman, Times, serif; text-align:left;">
            <strong>Lugar y fecha: </strong> La Paz - <?php echo e(date('Y-m-d')); ?>.
        </p>
        <br><br><br><br><br><br>
        <table style="width:100%;">
            <tr>
...
<?php /**PATH C:\laragon\www\bufet\resources\views/reporte/generaPdf.blade.php ENDPATH**/ ?>