	...
	<body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
		...
		<div class="d-flex flex-column flex-root app-root" id="kt_app_root">
			...
			<div class="app-page flex-column flex-column-fluid" id="kt_app_page">
				<!--begin::Header-->
				<div id="kt_app_header" class="app-header" style="background: #123344">
									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
                                            <form method="POST" action="<?php echo e(route('logout')); ?>">
                                                <?php echo csrf_field(); ?>
											    <a href="<?php echo e(route('logout')); ?>" class="menu-link px-5" onclick="event.preventDefault(); this.closest('form').submit();">Cerrar Sesion</a>
				...
				<div class="app-wrapper flex-column flex-row-fluid " id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						<!--begin::Logo-->
						<div class="app-sidebar-logo px-6" style="background: #123344;" id="kt_app_sidebar_logo">
							<!--begin::Logo image-->
							<a href="<?php echo e(url('/home')); ?>">
                                <center>
                                    <img alt="Logo" src="<?php echo e(asset('assets/media/logos/l1.jpeg')); ?>" class="h-100px app-sidebar-logo-default" style="margin-top: 25px;margin-right: 100px;" />
                                    <img alt="Logo" src="<?php echo e(asset('assets/media/logos/l1.jpeg')); ?>" class="h-20px app-sidebar-logo-minimize" />
                                </center>
							</a>
							<!--end::Logo image-->
        ...
        <script>
            ...
            toastr.options = {
              ...
              function miFuncion() {
                $.ajax({
                    url: "<?php echo e(url('tramite/verificaHoras')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        if (!(Array.isArray(data) && data.length == 0))
                            toastr.warning('¡FALTA POCO PARA EL '+data[0]+'!');
                    }
                });
              }

              function miFuncionProce() {
                $.ajax({
                    url: "<?php echo e(url('tramite/verificaHorasProceso')); ?>",
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        if (!(Array.isArray(data) && data.length == 0))
                            toastr.info('¡FALTA POCO PARA EL '+data[0]+'!');
                    }
                });
              }

              setInterval(miFuncion, 4000);
              setInterval(miFuncionProce, 4000);
        </script>
...
<?php /**PATH C:\laragon\www\bufet\resources\views/layouts/app.blade.php ENDPATH**/ ?>