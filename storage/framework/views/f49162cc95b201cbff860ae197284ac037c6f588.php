    ...
    <script type="text/javascript">
       ...
       function guardarCliente(){
            ...
            if($("#formularioRol")[0].checkValidity()){
                ...
                $.ajax({
                    url: "<?php echo e(url('tramite/guarda')); ?>",
                    data:formData,
                    type: 'POST',
                    dataType: 'json',
                    processData: false,
        ...
        function ajaxListado(){
            $.ajax({
                url: "<?php echo e(url('tramite/ajaxListado')); ?>",
                type: 'POST',
                dataType: 'json',
                success: function(data) {
                    if(data.estado === 'success')
        ...
        function eliminar(cliente){
            $.ajax({
                url: "<?php echo e(url('tramite/eliminar')); ?>",
                type: 'POST',
                data:{id:cliente},
                dataType: 'json',
                success: function(data) {
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\bufet\resources\views/tramite/listado.blade.php ENDPATH**/ ?>