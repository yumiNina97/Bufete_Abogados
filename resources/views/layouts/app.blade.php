									...
									<div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-800 menu-state-bg menu-state-color fw-semibold py-4 fs-6 w-275px" data-kt-menu="true">
										...
										<div class="menu-item px-5">
                                            <form method="POST" action="{{ route('logout') }}">
                                                @csrf
											    <a href="{{ route('logout') }}" class="menu-link px-5" onclick="event.preventDefault(); this.closest('form').submit();">Cerrar Sesion</a>
											...
											{{--  <a href="{{ route('logout') }}" class="menu-link px-5">Cerrar Sesion</a>  --}}
										</div>
										<!--end::Menu item-->
									</div>
				...
				<div class="app-wrapper flex-column flex-row-fluid " id="kt_app_wrapper">
					...
					<div id="kt_app_sidebar" class="app-sidebar flex-column" data-kt-drawer="true" data-kt-drawer-name="app-sidebar" data-kt-drawer-activate="{default: true, lg: false}" data-kt-drawer-overlay="true" data-kt-drawer-width="225px" data-kt-drawer-direction="start" data-kt-drawer-toggle="#kt_app_sidebar_mobile_toggle">
						...
						<div class="app-sidebar-logo px-6" style="background: #123344;" id="kt_app_sidebar_logo">
							...
							<a href="{{ url('/home') }}">
                                <center>
                                    <img alt="Logo" src="{{ asset('assets/media/logos/l1.jpeg') }}" class="h-100px app-sidebar-logo-default" style="margin-top: 25px;margin-right: 100px;" />
                                    <img alt="Logo" src="{{ asset('assets/media/logos/l1.jpeg') }}" class="h-20px app-sidebar-logo-minimize" />
                                </center>
							</a>
							<!--end::Logo image-->
        ...
        <script>
            ...
            toastr.options = {
              ...
              function miFuncionProce() {
                $.ajax({
                    url: "{{ url('tramite/verificaHorasProceso') }}",
                    type: 'GET',
                    dataType: 'json',
                    success: function(data) {
                        if (!(Array.isArray(data) && data.length == 0))
