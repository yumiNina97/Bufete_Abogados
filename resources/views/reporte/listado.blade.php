    ...
    <script type="text/javascript">
       ...
       function guardarVenta(){
        ...
        function ajaxListado(){
            $.ajax({
                url: "{{ url('reporte/ajaxListadoCliente') }}",
                type: 'POST',
                dataType: 'json',
                success: function(data) {
                    if(data.estado === 'success')
        ...
        function generaReporTramite(){
            ...
            if(!(fecha_ini == '' || fecha_fin == '')){
                var url = "{{ url('reporte/generaPdfTramite') }}/"+fecha_ini+"/"+fecha_fin;
        ...
        function generaReporteCliente(id){
            ...
            if(!(fecha_ini == '' || fecha_fin == '')){
                var url = "{{ url('reporte/generaPdf') }}/"+id+"/"+fecha_ini+"/"+fecha_fin;
                window.location.href = url;
            }
        }
    </script>
